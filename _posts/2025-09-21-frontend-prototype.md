...
원래 계획은 팀원들과 각자 페이지를 맡아 피그마 작업 후에 톤앤매너를 맞추고 코드화하려고 했었다.

그러나 피그마를 다들 처음 써보기도 하고, 다들 각자의 작업이 바쁘기 때문에 내가 초안을 작성하기로 했다.

## 프로토타입 제작기

우선 AI와 MCP를 적극 활용하기로 했기 때문에, 가장 먼저 피그마의 MCP를 써보기로 했다.

피그마의 MCP가 유료 기능이어서, 대신 MCP를 제공하는 플러그인을 찾았다.
