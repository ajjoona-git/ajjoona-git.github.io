...
tags: [Jekyll, Chirpy, Demo]      # 태그 (소문자 권장)
toc: true                            # 이 게시글에 플로팅 목차 표시
comments: true                         # 이 게시글에 Giscus 댓글 창 표시
image: /assets/img/posts/2025-10-01-test-post/banner.png # (선택) 대표 이미지
description: "Jekyll과 Chirpy 테마를 사용하여 GitHub Pages 기술 블로그를 구축하고 첫 포스팅을 테스트합니다."
---
